// Authentication Module for Taskvora
...
class Auth {
    ...
    async login() {
        ...
        try {
            ...
            if (data.success) {
                ...
                this.showMessage(data.message || 'Invalid email or password. Please try again.', 'danger');
    ...
    async register() {
        ...
        try {
            ...
            if (data.success) {
                ...
                // Clear any existing auth data - always require explicit login after register
    ...
    checkAuthState() {
        ...
        const protectedPages = ['dashboard.html', 'profile.html']; // Removed 'index.html' for testing
